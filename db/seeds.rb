...
@merch2_disc1 = BulkDiscount.create!(name: "Jewelry Discount 1", quantity: 5, percent_discount: 10, merchant_id: @merchant2.id)
@merch1_disc2 = BulkDiscount.create!(name: "Jewelry Discount 1", quantity: 10, percent_discount: 20, merchant_id: @merchant2.id)
...
@ii_10 = InvoiceItem.create!(invoice_id: @invoice_8.id, item_id: @item_5.id, quantity: 6, unit_price: 1, status: 1)
@ii_11 = InvoiceItem.create!(invoice_id: @invoice_8.id, item_id: @item_6.id, quantity: 4, unit_price: 1, status: 1)
